...
public class Reusable_Library_logger_POM {
    ...
    //click on element using explicit wait
    public static void clickByIndex(WebDriver driver, WebElement locator, int indexNumber, ExtentTest loggers, String elementName) throws IOException, InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        try {
            System.out.println("Clicking on element " + elementName);
            loggers.log(LogStatus.INFO, "Clicking on element " + elementName);
