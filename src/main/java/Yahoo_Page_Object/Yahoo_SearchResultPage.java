...
public class Yahoo_SearchResultPage extends Abstrat_class {
    ...
    public Yahoo_SearchResultPage searchNumber() throws IOException, InterruptedException {
        String searchresult = Reusable_Library_logger_POM.captureTextByIndex(driver,searchResultLocator,0,logger,"Search Result");
