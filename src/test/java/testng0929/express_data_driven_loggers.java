...
public class express_data_driven_loggers {
    ...
    public void openBrowser() throws IOException, BiffException {
        ...
        readFile = Workbook.getWorkbook(new File("src\\main\\resources\\Expresss.xls"));
        // create duplicate workbook to input new data
        writeFile = Workbook.createWorkbook(new File("src\\main\\resources\\Expresss_results.xls"),readFile);
    ...
    @Test
    public void clickOnMeeting() throws InterruptedException, WriteException, IOException {
